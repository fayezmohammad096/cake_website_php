<?php
 ...
 if(isset($_POST['btn'])){
     ...
     if(!empty($row_cost) && !empty($transport_cost) && !empty($space_cost) &&!empty( $staff_cost) &&!empty( $utility_cost)&&!empty( $selling_price)){
        ...
        $query = "INSERT INTO chocolate(row_cost,transport_cost,space_cost,staff_cost,utility_cost,selling_price,discount_price)VALUES($row_cost,$transport_cost,$space_cost,$staff_cost,$utility_cost,$selling_price,$discount_price)";
    ...
    <div class="container">
        <table class="table table-bordered">
            ...
            <?php
                ...
                if($readquery->num_rows >0){
                    while($read_data = mysqli_fetch_assoc($readquery)){
                        ...
                        $after_disc_selling = $disc_price * 9;//change
            ...
            <tr>
                ...
                <td> <a type="submit" class="btn btn-danger" href="chocolate.php?delete=<?php echo $id;?>">Delete </a></td><!--change-->
                <td></td>
            </tr>
            <?php }}else{
              echo "No Data Found";
