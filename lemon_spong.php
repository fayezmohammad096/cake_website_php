<?php
 ...
 if(isset($_POST['btn'])){
     ...
     if(!empty($row_cost) && !empty($transport_cost) && !empty($space_cost) &&!empty( $staff_cost) &&!empty( $utility_cost)&&!empty( $selling_price)){
        ...
        $query = "INSERT INTO lemon_sponge(row_cost,transport_cost,space_cost,staff_cost,utility_cost,selling_price,discount_price)VALUES($row_cost,$transport_cost,$space_cost,$staff_cost,$utility_cost,$selling_price,$discount_price)";
...
<?php
  if(isset($_GET['delete'])){
    ...
    $query = "DELETE FROM lemon_sponge WHERE id={$id}";
  ...
  <div class="container shadow m-5 p-3">
    ...
    <div class="container">
        <table class="table table-bordered">
            ...
            <?php
                $query = "SELECT * FROM lemon_sponge";
            ...
            <tr>
                ...
                <td> <a type="submit" class="btn btn-danger" href="lemon_spong.php?delete=<?php echo $id;?>">Delete </a></td><!--change-->
                <td></td>
            </tr>
            <?php }}else{
              echo "No Data Found";
